...
<html lang="en">
    <head>
      ...
      function displayLocation(location) {
        ...
        if (parseInt(location.lat) == 0) {
            ...
            var slat = <?php echo $_GET['slat'];?>;
            var slng = <?php echo $_GET['slng'];?>;
            var dlat = <?php echo $_GET['dlat'];?>;
            var dlng = <?php echo $_GET['dlng'];?>;
            var position = new google.maps.LatLng(slat, slng);
            var marker = new google.maps.Marker({
                map: map,
                position: position,
                title: location.name,
    ...
    <div id="sidebar" class="col-2" style="position:absolute; z-index:3; right:0;height: 100%; overflow:scroll; background-color:rgba(0,0,0,0.1); display:none;">
        <span onclick="closeFuc()" id="close">X</span>
        <div id="directions_panel"></div>
    </div>
    <div id="map_canvas" class="col-12" style="height: 100vmin; overflow-y: hidden; z-index:1;"></div>
